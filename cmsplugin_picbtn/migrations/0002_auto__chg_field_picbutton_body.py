...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PicButton.body'
        db.alter_column('cmsplugin_picbutton', 'body', self.gf('django.db.models.fields.TextField')())
    
    
    def backwards(self, orm):
        
        # Changing field 'PicButton.body'
        db.alter_column('cmsplugin_picbutton', 'body', self.gf('django.db.models.fields.CharField')(max_length=200))
    ...
    models = {
        ...
        'cmsplugin_picbtn.picbutton': {
            'Meta': {'object_name': 'PicButton', 'db_table': "'cmsplugin_picbutton'", '_ormbases': ['cms.CMSPlugin']},
            'background': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'body': ('django.db.models.fields.TextField', [], {}),
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'header': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'page_link': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cms.Page']"})
        },
        'sites.site': {
    ...
    complete_apps = ['cmsplugin_picbtn']
