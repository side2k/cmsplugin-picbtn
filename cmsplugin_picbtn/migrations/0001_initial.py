...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PicButton'
        db.create_table('cmsplugin_picbutton', (
            ...
            ('page_link', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Page'])),
            ('background', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('cmsplugin_picbtn', ['PicButton'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'PicButton'
        db.delete_table('cmsplugin_picbutton')
